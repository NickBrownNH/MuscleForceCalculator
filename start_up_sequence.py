...
title_label = ttk.Label(start_frame, text="University of Hartford", font=("Helvetica", 12))
title_label.pack(padx=20, pady=5)
title_label = ttk.Label(start_frame, text="Dr. Dan Liu, Brianna Durso, Nicholas Brown", font=("Helvetica", 12))
title_label.pack(padx=20, pady=5)
